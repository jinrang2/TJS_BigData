...
public class Ex02_round {
	...
	public static void main(String[] args) {
		...
		System.out.println("9.15를 올림 : " 	+ Math.ceil((double)9.15*10)/10);
		System.out.println("9.15를 반올림 : "	+ Math.round((double)9.15*10)/10.0);
		System.out.println("9.15를 버림 : "		+ Math.floor((double)9.15*10)/10);
